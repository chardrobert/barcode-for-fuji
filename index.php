...
/**
 * Barcode
 * Online barcode generator for the T950
 * 
 * I totally stole all this dude's code, so like give him some kudos or something
 *
 ...
 *
 * 
 * This page is for printing labels for the spectra T950 machine and above and beyond what Markus' code does it adds a checksum * digit which our robot definitely needs.
 *
 */
...
?>
        ...
        <p>Use this form to generate barcodes for the tape library. Each LTO label can contain at most six characters
        plus a two-character media identifier (L3, L4, etc.). A DLT label is limited to six characters.</p>
        <p>All feedback is unwelcome.</p>
        <p>Our current generation of tapes are LTO6, remember to check the checksum and colourized box and uncheck the border box, all the other defaults <i>should</i> be alright. <i>should.</i>
        <p>Latest update: 2016-12-29</p>
        <form name="barcodeGenerator" method="post" action="print.php">
            <table>
                <tr>
                    ...
                    <td><select name="tape" id="tape">
                        ...
                        <option value="l3" >LTO-3</option>
                        <option value="l4">LTO-4</option>
                        <option value="l5">LTO-5</option>
                        <option value="l6" selected="selected">LTO-6</option>
                        <option value="lw">LTO-6 Worm</option>
                        <option value="cu">Cleaning unit</option>
                        <option value="custom">Custom...</option>
                    </select>
                    <input type="text" name="suffix" id="suffix" value="L6" size="2" maxlength="2" /></td>
                </tr>
                <tr>
                    <th>Prefix: </th>
                ...
                <tr>
                    ...
                    <td><input type="text" maxlength=6 name="startno" id="startno" value="001" /></td>
                </tr>
                </tr>
                    <th>Sample: </th>
                    <td colspan=2><img src="lto-horizontal-color.png" id="sample"/></td>
                <tr>
            </table>
            ...
            <div id="advancedBlock">
                <table>
                    ...
                    <tr>
                        <th>Checksum: </th>
                        <td><input type="checkbox" name="checksum" value="true" id="checksum" /><label for="checksum"> the T950 requires this</label></td>
                    </tr>
                    
                    <tr>
                        <th>Borders: </th>
                        <td><input type="checkbox" name="borders" value="false" id="borders" checked="checked" /><label for="borders"> labels are printed with borders</label></td>
                    </tr>
                    <tr>
                        <th>Colorized: </th>
        ...
        <p>The original software is open source, and licensed under the Apache License v2. You can download the original source from github:<br />
        <code>https://github.com/markusberg/barcode</code></p>
        <p>my version is open source too I guess, and licensed under the Apache License v2. You can download my shitty source from github:<br />
        <code>https://github.com/chardrobert/barcodeFuji</code></p>
        <p>if you want to put this up somewhere remember to download the tcpdf library from <code>https://github.com/tecnickcom/TCPDF</code> and place into a folder named <code>tcpdf</code> in the same directory as the index.php</p>
<?php
$page->printFooter();
?>
